  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (userData.role === "ADMIN") {
        toast.success(
          `Welcome, ${userData.name}! Redirecting to Admin Panel…`,
          { icon: "🛡️" },
        );
        navigate("/admin");
      } else {
    ...
    <>
      ...
      <div className="flex min-h-screen relative z-10">
        ...
        <div className="hidden lg:flex w-1/2 flex-col justify-between p-14 relative overflow-hidden">
          {/* Background is handled by AuthBackground component */}
          ...
          <div className="relative z-10 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold leading-none text-white font-display">
                SmartBiz
              </h1>
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="space-y-4">
              {[
                {
                  icon: Building2,
                  text: "One platform for invoices, expenses & inventory",
                },
          ...
          <p className="relative z-10 text-xs text-indigo-500">
            © 2024 SmartBiz. All rights reserved.
          </p>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center p-8 bg-white/80 backdrop-blur-sm">
          <div className="w-full max-w-md">
            ...
            <div className="flex items-center gap-3 mb-8 lg:hidden">
              ...
              <h1 className="text-xl font-bold text-indigo-900 font-display">
                SmartBiz
              </h1>
            </div>

            <div className="mb-8">
              <h2 className="text-3xl font-bold text-indigo-900 font-display">
                Sign In
              </h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                {loading ? (
                  <>
                    <div className="w-5 h-5 border-2 rounded-full border-white/40 border-t-white animate-spin" />{" "}
                    Signing in…
                  </>
                ) : (
                  <>
            ...
            <p className="mt-6 text-sm text-center text-gray-500">
              ...
              <Link
                to="/register"
                className="font-semibold transition-colors text-primary-600 hover:text-primary-700"
              >
